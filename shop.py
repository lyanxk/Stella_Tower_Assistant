...
def handle_final_shop_refreshes() -> None:
    ...
    print("debug: reached final shop refresh limit, exiting shop")
    image, window_rect = capture_emulator()
    ...
    print("debug: quit shop after refresh limit")


def exit_regular_shop() -> None:
    print("Purchase process completed. Checking whether the shop can be closed...")
    back_template = load_template("back")
